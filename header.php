 ...
 <!-- Main Header -->
    <header class="main-header header-style-one">
                ...
                <div class="inner-container">
                    <div class="left-column">
                        <ul class="social-icon">
                            ...
                            <li><a target="blank" href="<?php echo $setting['whatsapp']; ?>"><i class="fab fa-whatsapp"></i></a></li>
                        </ul>
        ...
        <div class="header-upper">
            <div class="auto-container">
                <div class="inner-container">
                    <!--Logo-->
                    <div class="logo-box">
                        <div class="logo"><a href="index.php"><img src="assets/images/logo/abslogo.png" alt="logo"></a></div>
                    </div>
                    <div class="right-column">
                        <!--Nav Box-->
                        <div class="nav-outer">
                            <!--Mobile Navigation Toggler-->
                            <div class="mobile-nav-toggler"><img src="assets/images/icons/icon-bar-2.png" alt="logo"></div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation" >
                                        ...
                                        <li class="dropdown"><a href="faq.php">Testimonials</a>
                                       
                                        </li>-->
                                       
                                        <li class="dropdown"><a href="blog.php">Carrer</a>
                                          
                                        </li>
                                        <li><a href="contact.php">Contact Us</a></li>
                                         <div class="language">
                                        <!--<style>         ---------- color change to black but changes all color of sticky & header
                                            .navigation li a {
                                                color: black;
                                            }
                                            .navigation li a {
            ...
            <div class="header-upper">
                <div class="auto-container">
                    <div class="inner-container">
                        <!--Logo-->
                        <div class="logo-box">
                            <div class="logo"><a href="index.html"><img src="assets/images/logo/abslogo.png" alt="logo"></a></div>
                        </div>
                        <div class="right-column">
                            <!--Nav Box-->
                            <div class="nav-outer">
                                <!--Mobile Navigation Toggler-->
                                <div class="mobile-nav-toggler"><img src="assets/imgaes/logo/abslogo.png" alt="logo"></div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="assets/images/1.png" alt="" title=""></a></div>

...
if(isset($_POST['submit'])){
    ...
    if($check_fetch['ad_id'] != ''){
        ...
        ini_set('SMTP', 'mail.example.com'); // Replace with your mail server hostname or IP address
        ini_set('smtp_port', 587); // Replace with the appropriate SMTP port number
        ...
        echo 'Admin email not found. Please try again.';
    }
}
?>
<!DOCTYPE html>

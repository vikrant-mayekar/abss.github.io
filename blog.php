...
<head>
<meta charset="utf-8">
<title>Career - <?php echo $setting['site_name']; ?></title>
<meta name="description" content="We Offer Import & Export assistance foreign businesses in transporting and selling their products in China, India and USA. We connect domestic companies to the international shipping services most suited for their business.">
<!-- Stylesheets -->
<link href="assets/css/bootstrap.css" rel="stylesheet">
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
<link rel="stylesheet" href="style.css"> <!--change two types-->
    ...
    <!-- serivice from here -->
        ...
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2><strong style="color: #000080;">ABSS: </strong> The Key to Success in a Competitive Industry</h2>
            </div>
    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-md-12 text-center">
                <p><b>Are you looking for a challenging and rewarding career in customer service? If so, then a job may be the perfect fit for you!</b></p>
                <p>BPO jobs offer the opportunity to help people from all over the world, and to make a real difference in their lives. You'll get to use your communication and problem-solving skills to resolve customer issues, and to provide them with the best possible service.</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 zoom pb-5">
      <div class="card-deck h-100">
        <div class="card border-0 shadow-sm">
          ...
          <div class="card-body">
            <h5 class="card-title text-center"><b><a href="single-service.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></b></h5>
            <p class="card-text text-center"><?php echo $row['short']; ?></p>
          </div>
          <div class="card-footer bg-white">
            <div class="text-center">
              <a href="submit_application.php?id=<?php echo $row['id']; ?>" class="btn btn-primary px-4 py-2">Apply Now</a>
            </div>
          </div>
        </div>
      </div>
...
<script>
  $(document).ready(function() {
    // Add a zoom effect to the cards
    $('.card').zoom();

    // Add a smooth scroll to the links in the footer
